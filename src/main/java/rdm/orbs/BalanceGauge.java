...
/*
public class BalanceGauge {

    public abstract class BalanceGauge extends AbstractOrb {
        ...
        public BalanceGauge(String ID, int yOffset, Color projectileColor, String atlasString, String skeletonString, String animString, float scale, Color modelColor, int passive, int initialBoost, boolean movesToAttack, Color deathColor, SlimeFlareEffect.OrbFlareColor OrbFlareColor, Texture intentImage, String IMGURL) {
