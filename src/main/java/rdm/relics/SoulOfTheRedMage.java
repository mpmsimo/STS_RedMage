...
public class SoulOfTheRedMage extends CustomRelic {
    public static final String ID = "RDM:SoulOfTheRedMage";

    public SoulOfTheRedMage() {
        super(ID,
    ...
    @Override
    public AbstractRelic makeCopy() { return new SoulOfTheRedMage(); }
}